            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        {
                            Name = "Ghost 1",
                            Description = "This is the Ghost 1 movie description",
                            Price = 39.50,
                        ...
                        {
                            Name = "Ghost 2",
                            Description = "This is the Ghost 2 movie description",
                            Price = 39.50,
                        ...
                        {
                            Name = "Ghost 3",
                            Description = "This is the Ghost 3 movie description",
                            Price = 39.50,
                        ...
                        {
                            Name = "Ghost 4",
                            Description = "This is the Ghost 4 movie description",
                            Price = 39.50,
                        ...
                        {
                            Name = "Ghost 5",
                            Description = "This is the Ghost 5 movie description",
                            Price = 39.50,
